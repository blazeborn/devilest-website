...
└── Projects/
    ...
    └── media/ (optional media files)
        ...
        └── spacecalamity/
            └── concept1.jpg
Setup
Place the carousel file: Put projects-carousel.html in your website directory
Create Projects folder: Create a Projects folder with your projects.json file
Embed in main site: Load the carousel via iframe in your main website:
html
